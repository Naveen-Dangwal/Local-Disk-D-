...
<body>
    ...
    <div class="container id='about'">
        <h1 class="text-center m-4" id="about">About Us</h1>
        <div class="row">
            <div class="col-md-4">
                <img src="pic/heck5.jpg" alt="" style='width:90%'>
            </div>
            <div class="col-md-8 txtjst">
    ...
    <div class="container">
        <h1 class="tex4t-center m-4" id="event">My Events</h1>
        <div class="row">
<?php
...
while($row=$result->fetch_assoc()){
    ...
    echo '
       <div class="col-md-4 mb-3">
        <div class="card" style="width: 18rem;">
          <img src='. $row['event_img'] .' class="card-img-top" alt="..."
 ...
 ?>
    ...
    <div class="container">
    <h1 class="text-center m-4" id="contacts">Contact Us</h1>
    <div>
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3501.8715642213965!2d77.4476854!3d28.633611199999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cee3d4e3485ed%3A0xe0fe1689b57c7d2e!2sABESIT%20GROUP%20OF%20INSTITUTIONS!5e0!3m2!1sen!2sin!4v1719807785983!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    <hr class="border border-dark border-2 opacity-50">
    </div>
    <?php
